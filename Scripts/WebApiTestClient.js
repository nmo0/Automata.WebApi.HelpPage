...
(function () {
    ...
    function TestClientViewModel(data) {
        ...
        self.RequestMediaType.subscribe(function () {
            ...
            addOrReplaceHeader(headers, "Content-Encoding", "deflate");
            addOrReplaceHeader(headers, "token", "token");
...
function SendRequest(httpMethod, url, requestHeaders, requestBody, handleResponse) {
    ...
    try {
        ...
        alert("Cannot send request. Check the sValuePointrity setting of your browser if you are sending request to a different domain.");
        return false;
    }
